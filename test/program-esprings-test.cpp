...
TEST(Program, DISABLED_esprings) {
  ...
  ASSERT_FLOAT_EQ(0.0409248172084922, x1(0));
  ASSERT_FLOAT_EQ(0.0409248172084922, x1(1));
  ASSERT_FLOAT_EQ(-0.0130301827915078, x1(2));

  TensorRef<simit_float,3> x2 = x.get(p2);
  ASSERT_FLOAT_EQ(0.959075182791508, x2(0));
  ASSERT_FLOAT_EQ(0.0409248172084922, x2(1));
  ASSERT_FLOAT_EQ(-0.0130301827915078, x2(2));

  TensorRef<simit_float,3> x3 = x.get(p3);
  ASSERT_FLOAT_EQ(0.0409248172084922, x3(0));
  ASSERT_FLOAT_EQ(0.959075182791508, x3(1));
  ASSERT_FLOAT_EQ(-0.0130301827915078, x3(2));

  TensorRef<simit_float,3> x4 = x.get(p4);
  ASSERT_FLOAT_EQ(0.959075182791508, x4(0));
  ASSERT_FLOAT_EQ(0.959075182791508, x4(1));
  ASSERT_FLOAT_EQ(-0.0130301827915078, x4(2));

  TensorRef<simit_float,3> x5 = x.get(p5);
  ASSERT_FLOAT_EQ(0.0409248172084922, x5(0));
  ASSERT_FLOAT_EQ(0.0409248172084922, x5(1));
  ASSERT_FLOAT_EQ(0.905120182791508, x5(2));

  TensorRef<simit_float,3> x6 = x.get(p6);
  ASSERT_FLOAT_EQ(0.959075182791508, x6(0));
  ASSERT_FLOAT_EQ(0.0409248172084922, x6(1));
  ASSERT_FLOAT_EQ(0.905120182791508, x6(2));

  TensorRef<simit_float,3> x7 = x.get(p7);
  ASSERT_FLOAT_EQ(0.0409248172084922, x7(0));
  ASSERT_FLOAT_EQ(0.959075182791508, x7(1));
  ASSERT_FLOAT_EQ(0.905120182791508, x7(2));

  TensorRef<simit_float,3> x8 = x.get(p8);
  ASSERT_FLOAT_EQ(0.959075182791508, x8(0));
  ASSERT_FLOAT_EQ(0.959075182791508, x8(1));
  ASSERT_FLOAT_EQ(0.905120182791508, x8(2));
}
