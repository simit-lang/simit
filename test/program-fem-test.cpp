...
TEST(Program, femTet) {
  ...
  ASSERT_SIMIT_FLOAT_EQ(0.030899457015375883, x.get(vertRefs[100])(2));
  ASSERT_SIMIT_FLOAT_EQ(0.0028221631202928516,   x.get(vertRefs[200])(0));
  ASSERT_SIMIT_FLOAT_EQ(0.017969982607667911,   x.get(vertRefs[200])(1));
  ASSERT_SIMIT_FLOAT_EQ(0.012885386063393013,   x.get(vertRefs[200])(2));
