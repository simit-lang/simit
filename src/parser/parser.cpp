...
namespace  simit { namespace internal  {
  ...
  case 123:
    ...
    Expr fieldRead = FieldRead::make(elemOrSet, fieldName);

    if (!isScalar(fieldRead.type())) {
      fieldRead = ctx->getBuilder()->unaryElwiseExpr(IRBuilder::None,fieldRead);
    }

    (yylhs.value.expr) = new Expr(fieldRead);
  }
...
#undef YYCASE_
   ...
   Parser ::yyrline_[] =
  {
    ...
    1399,  1404,  1410,  1417,  1457,  1458,  1459,  1466,  1551,  1572,
    1575,  1584,  1590,  1594,  1598,  1608,  1609,  1610,  1611,  1615,
    1627,  1631,  1641,  1650,  1662,  1674,  1678,  1681,  1723,  1733,
    1738,  1746,  1749,  1763,  1769,  1772,  1775,  1825,  1829,  1830,
    1834,  1838,  1845,  1856,  1863,  1867,  1871,  1885,  1889,  1904,
    1908,  1915,  1922,  1926,  1930,  1944,  1948,  1963,  1967,  1974,
    1977,  1980,  1986,  1989,  1995,  1998,  2004,  2007,  2014,  2033,
    2057,  2058,  2066
  };
