...
namespace  simit { namespace internal  {
  ...
  case 97:
    ...
    {
    free((void*)(yystack_[0].value.string));
    (yylhs.value.TensorType) = new TensorType(TensorType::ELEMENT);
  }
  ...
  case 107:
    ...
    {
    (yylhs.value.ComponentType) = TensorType::INT;
  }
  ...
  case 108:
    ...
    {
    (yylhs.value.ComponentType) = TensorType::FLOAT;
  }
  ...
  case 114:
    ...
    auto type = new TensorType(TensorType::FLOAT, isps);
  ...
  case 115:
    ...
    auto isps = std::vector<IndexSetProduct>(values->dimSizes.rbegin(),
                                             values->dimSizes.rend());
    auto type = new TensorType(TensorType::INT, isps);
    auto literal = new LiteralTensor(type, values->values.data());
    (yylhs.value.LiteralTensor) = new shared_ptr<LiteralTensor>(literal);
  }
  ...
  case 132:
    ...
    {
    auto scalarType = new TensorType(TensorType::INT);
  ...
  case 133:
    ...
    {
    auto scalarType = new TensorType(TensorType::FLOAT);
...
#undef YYCASE_
  ...
  const unsigned short int
   Parser ::yyrline_[] =
  {
       0,   169,   169,   171,   175,   178,   181,   184,   187,   191,
     197,   201,   207,   210,   217,   221,   223,   225,   227,   230,
     240,   247,   256,   300,   303,   317,   321,   335,   343,   347,
     354,   357,   366,   367,   368,   369,   370,   374,   404,   412,
     418,   420,   424,   426,   433,   439,   474,   477,   492,   510,
     513,   516,   519,   524,   529,   534,   539,   544,   568,   572,
     577,   582,   587,   592,   597,   602,   607,   611,   616,   619,
     624,   627,   632,   635,   642,   648,   657,   664,   666,   671,
     673,   678,   680,   682,   685,   688,   691,   697,   698,   704,
     711,   720,   728,   733,   742,   770,   773,   778,   784,   787,
     793,   796,   834,   839,   846,   849,   853,   858,   861,   930,
     931,   933,   937,   938,   941,   949,   959,   966,   969,   973,
     986,   990,  1004,  1008,  1014,  1021,  1024,  1028,  1041,  1045,
    1059,  1063,  1069,  1074,  1083,  1088,  1090,  1093,  1094
  };
